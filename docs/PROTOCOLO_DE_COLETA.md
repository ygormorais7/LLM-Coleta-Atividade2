...
| 2 | Inventário da BDTD montado pelo grupo | `data/externo/inventario_saude.csv.gz` → página do item no repositório de origem | arquivo local + HTTP no repositório | 13/09/2026 | piloto (UFRN, UFPR, Fiocruz); **coleta até 20 mil PDFs autorizada em 13/09/2026** (até 800 candidatos por instituição; parada em 15.098); **coleta até 50 mil autorizada em 14/09/2026**, sem limite por instituição (fila esgotada em 15/09 com 24.443 PDFs) |
...
| 2026-09-14 15:33 – 2026-09-15 07:35 | Inventário BDTD — **coleta até 50 mil PDFs** (autorizada em 14/09/2026), sem limite por instituição | preparo (15:33–15:43): robots.txt de 23 domínios sem evidência + inventário; download em 2 execuções, ~11 mil tentativas | **24.443 PDFs no disco** (+9.345 sobre os 15.098; 64 instituições; 76 GB no total) | Fiocruz parou de responder (linha abaixo); disjuntor cortou UDESC e UFMS pela taxa real | **fila esgotada sem atingir a meta**, como previsto; testes e preflight antes de cada execução. Conta prévia: 58.491 candidatos → 33.921 em domínio autorizado → 23.591 fora das suspensas → 11.993 não baixados → **~26 mil PDFs esperados no total**; 50 mil só com fontes novas |
| 2026-09-14 15:47–17:05 | **Incidente — Fiocruz** (arca.fiocruz.br), durante a coleta até 50 mil | 18 downloads normais (15:44–15:47) e depois **376 tentativas seguidas sem resposta** | 18 PDFs | o servidor passou a aceitar a conexão sem responder (tempo esgotado; confirmado com 1 requisição às 17:3x). **Possível bloqueio.** O disjuntor só cortou às 17:05 (860 de 1.229): com o histórico de 842 PDFs no placar, a taxa acumulada reagiu devagar demais — **defeito do disjuntor** | Fiocruz suspensa; disjuntor passa a cortar também após **20 falhas de rede seguidas** (sem resposta, bloqueio, HTTP 429/5xx). 404, 401 e PDF ausente não entram na sequência: nesta mesma execução a UFSCar teve 62 PDFs ausentes seguidos e a UFMA 25 links 404, com as duas funcionando, e seriam cortadas por engano. Coletor passa a distinguir `sem_resposta` de `pdf_nao_localizado`; 160 testes. **Execução encerrada às 17:40 com 20.250 PDFs no disco e reiniciada às 17:40** (testes e preflight antes). Sem contato do administrador até agora |
| 2026-09-14 17:40 – 2026-09-15 07:35 | 2ª execução da coleta até 50 mil, com o disjuntor corrigido | ~4,9 mil tentativas (UFRN 2.475, UFES 730, UFSCar 550, UFG 513, UFMA 212) | **4.223 PDFs**; 24.443 no disco ao fim | falhas: 280 PDF não localizado, 205 HTTP 404 (UFMA), 109 HTTP 401 (UEM, UNIPAMPA), 32 arquivo que não é PDF, 21 sem resposta, 7 acima do tamanho máximo; **nenhum corte por falhas de rede seguidas** | terminou sozinha com a fila esgotada (`saida=0`); taxa de resolução global 97,4% |
